...
- 2022-09-22 ~ 2023-02-23 <br>
- java/javascript/html/css 등 웹에 대한 프로그래밍 언어 학습 및 전반적인 구조 습득
- java의 spirng boot를 활용한 캐치테이블 웹 버전 개발 및 클론코딩
- 크롤링, 자연어처리를 이용하여 캐치테이블의 리뷰 데이터 수집 및 분석
<hr>

- [x] AI기반 챗봇 및 OCR 개발 전문가 과정
- 2024-03-08 ~ 2024-09-05 <br>
- python, web서비스를 위한 node.js/fastapi/html/css/javascript 학습
- 공공API를 사용한 앱을 개발 (저소득층을 위한 서비스 소개 및 추천 앱 개발)
- 그림일기 프로젝트를 진행하기 위해 그림생성, 감정분석, 워드임베딩, 유사도분석 OCR등을 공부
- 다양한 모델들을 한데 엮어 텍스트를 삽입하면 그림일기를 생성해주는 함수 완성
- 컴퓨터비전(cv2), OCR를 공부하고 활용하여 마지막 컴퓨터비전 프로젝트를 진행(원하는 사람외의 얼굴은 블러처리)
<hr>
